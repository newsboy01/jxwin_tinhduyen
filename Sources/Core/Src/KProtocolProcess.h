...
public:
	...
	void s2cLockMove(BYTE *pMsg);		  // trungnh lockmove
	void s2cSendMsgValueSync(BYTE *pMsg); // trungnh SendMsgSystem
	...
	void LockMove(int nIndex, BYTE *pProtocol);	 // trungnh lockmove
