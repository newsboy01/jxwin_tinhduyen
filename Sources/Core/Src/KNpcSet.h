...
public:
	...
	BOOL			ExecuteScript(int nNpcIndex, char* szScriptName, char* szFuncName, int nParam); //trungnh SetNpcTimeOut
	BOOL			ExecuteScript(int nNpcIndex, DWORD dwScriptId, char* szFuncName, int nParam); //trungnh SetNpcTimeOut
#endif
private:
