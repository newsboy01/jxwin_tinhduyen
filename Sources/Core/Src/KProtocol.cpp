...
int g_nProtocolSize[MAX_PROTOCOL_NUM] =
	{
		...
		sizeof(PLAYER_LOCKMOVE),		  // s2c_lockmove trungnh lockmove
		sizeof(SEND_MSG_SYSTEM_SYNC),	  // trungnh s2c_sendsyncmsgsystemvalue
		...
		sizeof(PLAYER_LOCKMOVE),		  // c2s_lockmove trungnh lockmove
