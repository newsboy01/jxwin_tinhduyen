...
{
private:
	int m_nPlayerIndex; // 指向对应的player数组的位置 trungnh m_nMsgValue msgconten
public:
#ifdef _SERVER
	...
	char msgconten[128];							  // trungnh m_nMsgValue msgconten
#endif
...
public:
	...
	void SendMsgSystem(int nIdPlayer, char *nMsgValue);			   // trungnh SendMsgSystem
...
public:
	void SendMsgSystem(char *nMsgValue);									// trungnh SendMsgSystem
